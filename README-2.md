...
After cleaning and filtering, the final training set contains **19,230 matches** across **8 major teams** (Australia, Bangladesh, England, India, New Zealand, Pakistan, South Africa, Sri Lanka, West Indies) and **20+ venues**.
...
|---|---|
| **R² Score** | **0.85** |
| **MAE (Mean Absolute Error)** | **±8.49 runs** |

On the held-out test set, the model explains about 85% of the variance in final scores, with an average prediction error of roughly **±8.5 runs**.
...
```bash
git clone https://github.com/priyanshu18611/Cricket-Score-Predictor.git
